        ...
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    ...
                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>ESPETO DE MORANGO</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                            Morango espetado no espeto, coberto por chocolate preto ou branco.
                        </Text>
                    </View>
                    ...
                    <View style={{ padding: 17 }}>
                        <View style={{ flexDirection: "row" }}>
                            <View style={styles.cardPreco}>
                                <Text style={{ fontFamily: 'PatuaOne-Regular', textAlign: 'center', fontSize: 18, padding: 12, color: '#ffffff'}}>R$18,00</Text>
                            </View>
