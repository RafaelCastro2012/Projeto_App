        ...
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    ...
                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>PÉ DE MOLEQUE DE NINHO</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                             Doce artesanal à base de amendoim torrado, açúcar caramelizado, e leite ninho, após o preparo é passado no leite ninho.
                        </Text>
                    </View>
