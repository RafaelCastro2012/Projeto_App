...
export default function KitdeTresDoces({ navigation }) {
    return (
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    ...
                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>KIT DE 3 DOCES</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                            Kit com 3 doces finos, contendo Brigadeiro Preto com granulado, ou com KitKat, contendo Brigadeiro Branco com Uva Verde ou Nuttela,
