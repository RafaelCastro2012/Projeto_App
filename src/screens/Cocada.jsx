        ...
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    ...
                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>COCADA</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                             Doce feita com coco fresco ralado. Temos diversos sabores cocada branca ou cocada preta. 
                             Uma doçura simples e irresistível.
                        </Text>
                    </View>
