            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    <View>
                        ...
                        <Image style={styles.imgProdutos} source={cocadaCremosadeMaracuja} />
                    </View>

                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>COCADA CREMOSA DE MARACUJÁ</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                            Um doce cremoso, de cocada com leite condensado, acompanhado com geleia de maracujá
                        </Text>
                    </View>
