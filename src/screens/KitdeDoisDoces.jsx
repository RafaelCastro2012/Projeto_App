        ...
        <SafeAreaProvider>
            <SafeAreaView style={{ flex: 1, backgroundColor: '#4F4132' }}>
                <ScrollView>
                    ...
                    <View>
                        <Text style={{ fontFamily: 'PatuaOne-Regular', fontSize: 25, padding: 20, color: "#FFFFFF" }}>KIT DE 2 DOCES</Text>
                        <Text style={{ fontFamily: 'PatuaOne-StackSansText-VariableFont_wght', fontSize: 20, marginLeft: 20, color: "#FFFFFF" }}>
                            Kit com 2 doces finos, contendo Brigadeiro Preto com granulado, ou com KitKat, contendo Brigadeiro Branco com Uva Verde ou Nuttela,
                    ...
                    <View style={{ padding: 17 }}>
                        <View style={{ flexDirection: "row" }}>
                            <View style={styles.cardPreco}>
                                <Text style={{ fontFamily: 'PatuaOne-Regular', textAlign: 'center', fontSize: 18, padding: 12, color: '#ffffff'}}>R$15,00</Text>
                            </View>
